...
public class VentanaSesionesPaciente extends JFrame{
	...
	ControladorSesionesPaciente controlador;
	Vector<Sesion>data_Sesion;

	
	public void addController(ControladorSesionesPaciente mc, Paciente usuarioPaciente, Vector<Sesion> ses){
		controlador = mc; 
